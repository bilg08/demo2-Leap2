...
import PostModal from "../PostModel/model";
import MenuList from "../ui/menuList";
import MenuList2 from "../ui/menuList2";
const UserSideBar = () => {
      ...
      <aside className="w-64" aria-label="Sidebar">
        <div className="overflow-y-auto py-4 px-3 bg-purple-300 rounded dark:bg-gray-800 flex-col items-center h-full">
          <ul className="space-y-2">
            ...
            {/* ovgig uurchluh */}
            <MenuList name={"Tsolmonbayar"} spanText={"Овог"} href={""} />
            {/* neriig uurchluh */}
            <MenuList name={"Enerel"} spanText={"Нэр"} href={""} />
            <MenuList name={"NUM"} spanText={"Их сургууль"} href={"/num"} />
            <MenuList name={"1"} spanText={"Курс"} href={""} />
          </ul>
